    ...
    <>
                ...
                <ul className="space-y-5">
                  ...
                  <li className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-text-primary">Leehove 40, 2678 MC De Lier</p>
                      <a
                  ...
                  <li className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-text-primary">Mon – Fri: 9:00 – 18:00 GMT</p>
                    </div>
                  </li>
                </ul>
              </div>
      ...
      <section className="py-14 md:py-20 bg-bg-secondary border-t border-border-subtle">
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-text-primary mb-8 md:mb-12 text-center">
