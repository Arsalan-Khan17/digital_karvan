      ...
      <section className="py-16 bg-bg-primary">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
              ...
              <Link key={post.id} href={`/blog/${post.slug}`}>
                <div className="group rounded-2xl overflow-hidden bg-bg-card border border-border-subtle hover:border-white/20 transition-all duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <h2 className="text-xl font-semibold text-white group-hover:text-text-secondary transition-colors leading-snug mb-3">
                      {post.title}
                    </h2>
          ...
          <div className="mt-16 flex items-center justify-center gap-2">
            <button className="px-4 py-2 rounded-lg border border-border-default text-text-secondary text-sm hover:text-white hover:border-white/30 transition-colors">
              Previous
            </button>
            <span className="px-4 py-2 text-sm text-white font-medium">1</span>
            <button className="px-4 py-2 rounded-lg border border-border-default text-text-secondary text-sm hover:text-white hover:border-white/30 transition-colors">
              Next
            </button>
          </div>
