  ...
  return (
    <>
      ...
      <section className="py-20 bg-bg-primary">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white mb-12">Life at Digital Karvan</h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {jobs.map((job) => (
              <div
                key={job.id}
                className="group p-6 md:p-8 rounded-2xl bg-bg-card border border-border-subtle hover:border-white/20 transition-all duration-300"
              >
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-3 mb-3">
                      <span className="text-xs px-2 py-1 rounded-full bg-bg-elevated border border-border-default text-text-secondary">
                        {job.department}
                      </span>
                    </div>
          ...
          <div className="mt-12 p-8 rounded-2xl border border-border-default text-center">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-6 py-3 bg-white text-black text-sm font-medium rounded-full hover:bg-gray-100 transition-colors"
            >
              Get in Touch
              <ArrowRight size={14} />
            </Link>
