        ...
        <div className="space-y-10 text-text-secondary">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong className="text-white">Essential cookies:</strong> These are necessary for the
                website to function properly and cannot be disabled.
              </li>
              <li>
                <strong className="text-white">Analytics cookies:</strong> These help us understand how
                visitors interact with our website so we can improve the user experience.
              </li>
              <li>
                <strong className="text-white">Preference cookies:</strong> These remember your settings
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border-default">
                    <th className="text-left py-3 pr-4 text-white font-medium">Cookie</th>
