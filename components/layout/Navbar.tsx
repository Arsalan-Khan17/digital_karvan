    ...
    <>
      <motion.header
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
          scrolled ? "bg-black/95 backdrop-blur-md border-b border-border-subtle" : "bg-transparent"
        }`}
                          ...
                          >
                            {link.dropdown.map((item) => (
                              <Link
                                key={item.href}
                                href={item.href}
                                className="block px-4 py-3 text-sm text-text-secondary hover:text-white hover:bg-bg-elevated transition-colors border-b border-border-subtle last:border-0"
                              >
                                {item.label}
                              </Link>
                            ))}
