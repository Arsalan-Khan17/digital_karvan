...
export const projects: Project[] = [
  {
    ...
    categories: ['Website'],
    date: 'Jul 27, 2025',
    logoUrl: '/images/portfolio/smartflyer/logo.png',
  ...
  },
  {
    ...
    date: 'Nov 14, 2023',
    logoUrl: '/images/portfolio/LMS/logo.png',
  ...
  },
  {
    ...
    categories: ['Technology', 'Website'],
    date: 'Mar 10, 2026',
    logoUrl: '/images/portfolio/vocal-fusion/logo.png',
  ...
  },
  {
    ...
    date: 'Mar 10, 2026',
    logoUrl: '/images/portfolio/bok/logo.png',
    ...
    mainImage : '/images/portfolio/bok/BOK-dash.png',
    screenshot_1 : '',
    screenshot_2 : '',
  ...
  },
  {
    ...
    categories: ['Technology'],
    date: 'Mar 8, 2026',
    logoUrl: '/images/portfolio/addidas/adidas.png',
  ...
  },
  {
    ...
    categories: ['Technology', 'Website'],
    date: 'Mar 4, 2026',
    logoUrl: '/images/portfolio/streamVi/video-strem.png',
  ...
  },
  {
    ...
    categories: ['Technology', 'Website'],
    date: 'Mar 10, 2026',
    logoUrl: '/images/portfolio/docx/logo.png',
  ...
  //   categories: ['Technology'],
  //   date: 'Nov 14, 2023',
  //   logoUrl: '/images/portfolio/docx/DocExtract.png',
...
export const team: TeamMember[] = [
  ...
  },
  {
    id: '2',
    name: 'Ayaan Khan',
    role: 'Business Development Strategy Head​',
    isFounder: false,
    imageUrl: '',
    bio: null,
    linkedin: null,
...
export const testimonials: Testimonial[] = [
  ...
  // { id: '3', name: 'Haris Sohail', source: 'Founder, VoiceAI Studios', text: 'Outstanding work from start to finish. Digital Karvan delivered a world-class digital solution on time and within budget. The platform they built is the backbone of our product. Highly recommended.' },
  { id: '4', name: 'Ameen Sajid', source: 'Operations Director, Bank of Khyber', text: 'We have worked with many agencies over the years, but Digital Karvan stands out for their integrity and the quality of their deliverables. They understood our enterprise constraints and delivered anyway.' },
  ...
  { id: '6', name: 'Ali Murtaza', source: 'Product Manager, Alternates', text: 'The level of technical expertise combined with creative excellence at Digital Karvan is genuinely rare. They built us a platform that scaled to 9,400 concurrent users on the first major enrolment day.' },
